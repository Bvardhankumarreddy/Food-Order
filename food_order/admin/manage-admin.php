            ...
            <div class="wrapper">
                ...
                <table class="tbl-full">
                    ...
                    if ($res==TRUE){
                        ...
                        $count = mysqli_num_rows($res); //Function to get all the rows in the admin table
                        ...
                        if($count>0)
                        {
                            ...
                            while($rows=mysqli_fetch_assoc($res))
                            {
                                ...
                                //And while loop will run as long s we have data n database
                                ...
                                <tr>
                                    ...
                                    <a href="<?php echo SITEURL;?>admin/update-admin.php?id=<?php echo $id;?>" class="btn-secondary">Update Amin</a> 
